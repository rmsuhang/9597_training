...
public class CANdleSystem extends SubsystemBase {
    ...
    //private XboxController joystick;//手柄控制到RobotContainer里面编辑
    ...
    public void incrementAnimation() {//更换下一个灯效
    ...
    public void decrementAnimation() {//更换上一个灯效
        switch(m_currentAnimation) {
    ...
    public void blue() {    ///亮蓝色
        m_candle.animate(null);
        m_candle.setLEDs(0, 0, 255);
        }

    public Command setfirewithmotorCommand() {//按下火焰灯亮，松开灯灭
    ...
    public Command setrgbfagewithmotorCommand() {//按下rgb灯亮，松开灯灭
